...
> Legacy warning: this is the old Caipi desktop app for Claude/Codex.
> The current Caipi online agent workspace lives at `/Users/pietz/Private/ai-vault`.
> Do not use this repo for current Caipi workspace work unless Paul explicitly asks for the legacy desktop app.
